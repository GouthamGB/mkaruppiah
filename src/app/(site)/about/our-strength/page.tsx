  ...
  return (
    <div className="w-full">
      ...
      <section className="bg-slate-900 text-white pt-32 pb-20 relative overflow-hidden">
        <div className="absolute top-1/2 left-0 -translate-y-1/2 h-96 w-96 rounded-full bg-brand-gold/15 blur-[120px] pointer-events-none"></div>
        <div className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-brand-blue/20 blur-[120px] pointer-events-none"></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {directors.map((member, index) => (
                <div
                  key={index}
                  className="group bg-white dark:bg-slate-900 rounded-lg overflow-hidden border border-slate-200/60 dark:border-slate-800 shadow-sm hover:border-brand-gold/50 hover:shadow-xl transition-all duration-300"
                >
                  {/* Portrait Wrapper */}
                  ...
                  <div className="p-6 space-y-1">
                    ...
                    <p className="text-brand-blue dark:text-brand-gold text-sm font-semibold flex items-center">
